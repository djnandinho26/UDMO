                                        ...
                                        case "max":
                                            {
                                                ...
                                                {
                                                    client.Send(new SystemMessagePacket($"Partner already at max level {(int)GeneralSizeEnum.DigimonLevelMax}..."));
                                                    break;
                                                }
                            ...
                            foreach (var target in party.Members.Values.Where(x => x.Id != client.TamerId))
                            {
                                ...
                                targetClient.Send(
                                    UtilitiesFunctions.GroupPackets(
                                        new PartyMemberWarpGatePacket(party[client.TamerId], targetClient.Tamer).Serialize(),
