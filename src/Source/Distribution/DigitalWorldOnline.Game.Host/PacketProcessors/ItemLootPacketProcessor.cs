                            ...
                            if (client.Tamer.Inventory.AddItem(aquireClone))
                            {
                                ...
                                if (party != null)
                                {
                                    foreach (var memberId in party.GetMembersIdList())
                                    {
                                        ...
                                        if (targetMessage != null) targetMessage.Send(new PartyLootItemPacket(client.Tamer, aquireClone).Serialize());
                                        if (targetDungeon != null) targetDungeon.Send(new PartyLootItemPacket(client.Tamer, aquireClone).Serialize());
                                    }
                                }
